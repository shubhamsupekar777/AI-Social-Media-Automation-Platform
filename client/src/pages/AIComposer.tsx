...
//     } catch (error: any) {
//       toast.error(
//         error?.response?.data?.message || error?.message || "Failed to fetch generations"
//       );
//     }
//   };
...
//               disabled={loading}
//               className="bg-slate-900 hover:bg-slate-800 text-white flex items-center gap-2 px-4 py-2 rounded-lg disabled:opacity-60"
//             >
//               {loading ? (
//                 <>
//                   <Loader2Icon className="size-4 animate-spin" />
...
//                 disabled={scheduling}
//                 className="w-full flex items-center justify-center gap-2 py-3 rounded-md bg-slate-200 text-slate-700 hover:bg-red-500 hover:text-white transition disabled:opacity-60"
//               >
//                 {scheduling ? (
//                   <Loader2Icon className="size-4 animate-spin" />
//                 ) : (
